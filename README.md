...
- You should have completed the [Whitelist dApp tutorial](https://github.com/pareshkapdiya/Whitelist-Dapp)
...
- In your public folder, download this folder and all the images in it (https://github.com/pareshkapdiya/NFT-Collection/tree/main/my-app/public/cryptodevs). Make sure that the name of the downloaded folder is `cryptodevs`
...
- Add the following lines to `[tokenId].js` file. Read about adding API routes in `next js` [here](https://nextjs.org/docs/api-routes/introduction)
  ...
  export default function handler(req, res) {
    ...
    const image_url =
      `https://github.com/pareshkapdiya/NFT-Collection/my-app/public/cryptodevs/${Number(tokenId) - 1}.svg`;
